        ...
        for(int j=0;j <= _discretize_step; j++){        //acc_input_ay
            ...
            for(int k=0; k <= _discretize_step; k++){   //acc_input_az
                ...
                for(int step=0 ; step<=_time_step ; step ++){
                    ...
                    */
                    pos(0) += vel(0) * delta_time + 0.5 * acc_input(0) * pow(delta_time, 2);
                    pos(1) += vel(1) * delta_time + 0.5 * acc_input(1) * pow(delta_time, 2);
                    pos(2) += vel(2) * delta_time + 0.5 * acc_input(2) * pow(delta_time, 2);
